...
#include <memory>
#include "../../SerialImageCapture/guiworker.h"
...
QT_MOC_LITERAL(3, 20, 7), // "success"
QT_MOC_LITERAL(4, 28, 11) // "doSomething"

    },
    "GUIWorker\0finished\0\0success\0doSomething"
};
...
void GUIWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (GUIWorker::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GUIWorker::finished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GUIWorker::finished(bool _t1)
{
